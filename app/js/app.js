...
.controller('indexCtrl', ['$scope', '$http', function($scope, $http) {
  ...
  $scope.getSuggestion = function() {
    ...
    xhr.open("GET", "https://api.cognitive.microsoft.com/bing/v5.0/Suggestions/?q=" + "bill g");
    xhr.setRequestHeader("Ocp-Apim-Subscription-Key", 'ab77602f5bd44f8392832be857240950');
    xhr.send();
    xhr.onload = function() {
    console.log(JSON.parse(xhr.responseText).suggestionGroups[0]);
    return (JSON.parse(xhr.responseText).suggestionGroups[0]);
  }
